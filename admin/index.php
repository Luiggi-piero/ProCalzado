...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>ProCalzado</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="avatars/avatar.png" style="width:35px;height:35px;" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="avatars/avatar.png" style="width:35px;height:35px;" class="user-image" alt="User Image">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="chart">
        ...
        $query = "SELECT * FROM compra WHERE 1";
        ...
        while($r = mysqli_fetch_array($q)) {
          ...
          $fecha = date("Y-m", strtotime($r["fecha"]));

          if(isset($ventas[$fecha])) {
            $ventas[$fecha] = $ventas[$fecha] + 1;
          } else $ventas[$fecha] = 1;
        }
...
<!--
        ...
        <!-- ./col  falta cerrar comentario-->
   <!--     <div class="col-lg-3 col-xs-6">       -->
          <!-- small box falta cerrar comentario-->
