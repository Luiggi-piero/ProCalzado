...
if(isset($enviar)){
	...
	$insert = $mysqli->query("INSERT INTO productos (name,price,imagen,oferta,descargable,id_categoria) VALUES ('$name','$price','$imagen','$oferta','$descargable', '$categoria')");

	if($insert == TRUE) {
		// echo "<h2>success</h2>";
	} else {
		echo "<h2>Hubo un error procesando lo solicitado</h2>";
		// echo $mysqli->error;
	}
...
<form method="post" action="" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input min="0" type="number" class="form-control" name="price" placeholder="Precio del producto" required/>
